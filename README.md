...
# Attention
Cette extension ne récupère aucune information qui n'est pas << affichée >> ou qui ne devrait pas être montrée. C'est juste une formule qui se sert des donnés à disposition pour fournir et afficher une estimation du rang qui se peut être grossière (+- 5 rang ou plus). Le résultat n'est pas garanti et il revient à vous de prendre ce rang avec un esprit critique. Elle permet une meilleure visualisation de son niveau mais il est déconséillé de ne se baser que sur cette donnée là.
